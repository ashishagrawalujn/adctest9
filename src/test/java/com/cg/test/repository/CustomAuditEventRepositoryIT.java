...
import com.cg.test.config.audit.AuditEventConverter;
import com.cg.test.domain.PersistentAuditEvent;
...
import static com.cg.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
